package com.simon.margaret.util.launchstarter;
...
import com.simon.margaret.util.launchstarter.sort.TaskSortUtil;
import com.simon.margaret.util.launchstarter.stat.TaskStat;
import com.simon.margaret.util.launchstarter.task.DispatchRunnable;
import com.simon.margaret.util.launchstarter.task.Task;
import com.simon.margaret.util.launchstarter.task.TaskCallBack;
import com.simon.margaret.util.launchstarter.utils.DispatcherLog;
import com.simon.margaret.util.thread.ThreadCommonUtils;
...
public class TaskDispatcher {
    ...
    public static void init(Context context) {
        if (context != null) {
            sContext = context;
            sHasInit = true;
            sIsMainProcess = ThreadCommonUtils.isMainProcess(sContext);
        }
    }
